...
function normalizePayload(body = {}) {
  return {
    ...
    link: body.link || '#',
    title: body.title || '',
    placement: body.placement || 'double_small',
...
function toFields(payload) {
  return [
    ...
    { key: 'placement', value: payload.placement },
...
function mapNode(node) {
  ...
  return {
    ...
    link: map.get('link') || '#',
    title: map.get('title') || '',
    placement: map.get('placement') || 'double_small',
...
export async function POST(request) {
  try {
    ...
    const mutation = `
      mutation CreateBanner($metaobject: MetaobjectCreateInput!) {
...
export async function PUT(request) {
  try {
    ...
    const mutation = `
      mutation UpdateBanner($id: ID!, $metaobject: MetaobjectUpdateInput!) {
